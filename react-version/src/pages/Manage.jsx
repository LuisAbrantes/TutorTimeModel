...
const Manage = ({ senha, navigate }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const processedSubjects = subjectsResponse.data.map((subject) => ({
          ...subject,
  ...
  const handleAddTutorial = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_BASE_URL}/tutorials`, formData);
  ...
  const handleDeleteSubject = async (id) => {
    try {
      ...
      setTutorials(tutorials.filter((tutorial) => tutorial.materiaId !== id));
  ...
  const filteredTutorials = useMemo(() => {
    ...
    return tutorials.filter((tutorial) => {
      ...
      // Filtro por matéria
      const filterMatch =
        filterBy === "all" || tutorial.materiaId.toString() === filterBy;
                    ...
                    >
                      <div className="flex items-center">
                        <div
                          ...
                          style={{
                            backgroundImage: `url(${
                              subject.imagemUrl || DEFAULT_IMAGE
                            })`,
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          ...
                          deleteConfirm.id === tutorial.id ? (
                            ...
                            <button
                              onClick={() =>
                                confirmDelete("tutorial", tutorial.id)
                              }
