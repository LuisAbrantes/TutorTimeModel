...
const ShareButton = React.memo(({ tutorial }) => {
  ...
  return (
    <div className="relative" ref={shareOptionsRef}>
      ...
      {showQRCode && (
        <QRCodeModal url={shareURL} onClose={() => setShowQRCode(false)} />
      )}
    </div>
  );
});
    ...
    try {
      ...
      const filteredTutorials = response.data
        .filter((tutorial) => {
          ...
          if (!tutorial || !tutorial.Materia || !tutorial.Materia.nome) {
            return false;
          }
          return tutorial.Materia.nome.toLowerCase() === materia.toLowerCase();
        })
        .map((tutorial) => ({
          ...tutorial,
        ...
        {isLoading ? (
          ...
          <>
            <div className="mb-4 bg-gray-800/30 p-3 rounded-lg text-sm text-gray-400">
              <span className="font-medium">Dicas de atalhos:</span> Pressione{" "}
            ...
            <div className="mb-6 flex justify-between items-center">
              <div className="text-gray-400">
                Exibindo {filteredTutorials.length} de {tutorials.length}{" "}
                monitorias
              </div>
                        ...
                        <div className="p-5 flex-1">
                          ...
                          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-gray-300">{tutorial.local}</p>
                            </div>
                          </div>
            ...
            {filteredTutorials.length === 0 && (
              <div className="text-center py-10">
                ...
                <p className="text-gray-400 text-lg">
                  Nenhuma monitoria corresponde aos filtros selecionados.
                </p>
                <button
                  onClick={clearFilters}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center p-4 animate-fadeIn">
          ...
          >
            ...
            <div className="p-6">
                  ...
                  <ul className="space-y-3 text-gray-300">
                    ...
                    <li className="flex">
                      ...
                      <span>
                        ...
                        {selectedTutorial.Professor.nome}
                      </span>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li className="flex">
                      ...
                      <span>
                        ...
                        {selectedTutorial.horario} - {selectedTutorial.dia}
                      </span>
                    </li>
                    <li className="flex">
              ...
              <div className="mb-6">
                <h3 className="text-primary font-semibold mb-2">Descrição</h3>
